# scripts to preprocess GWAS summary statistics for SkBmd
...
# gwas_file <- "resources/sumstats/gwas/LsBmd.gwas"
# chain_file <- "resources/misc/hg19ToHg38.over.chain"
# output_filepath <- "resources/pipeline_ma/LsBmd.ma"

source(liftover_script)

# Load tenk10k frequency file
