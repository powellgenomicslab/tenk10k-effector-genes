...
canon_genes <- read.csv("resources/crohns_case_study/crohns_relevant_gene_lists/sources/Systematic Review of Crohns Disease Genes.csv")
...
write.csv(canon_genes, "resources/crohns_case_study/supplementary_reports/canonical_gene_info_table_etal_2023.csv", row.names = F)

canon_genes_genes <- canon_genes %>% pull(Gene)

saveRDS(canon_genes_genes, "resources/crohns_case_study/crohns_relevant_gene_lists/canonical_genes.RDS")
